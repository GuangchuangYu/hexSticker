...
imageMagick is required to draw the sticker.  If you have not installed it, please try the following [approachs](https://www.imagemagick.org/script/download.php) to install the imageMagick.

### Fail to load 'sysfonts' 
 
In Mac os, you may need to reinstall the sysfornt to properly load it.  Be sure to install *xqartz* first.
