...
imageMagick is required to draw the sticker.  If you have not installed it, please try the following [approachs](https://www.imagemagick.org/script/download.php).
